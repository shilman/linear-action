...
const external_node_http_namespaceObject = require("http");
;// CONCATENATED MODULE: external "https"
const external_node_https_namespaceObject = require("https");
;// CONCATENATED MODULE: external "zlib"
const external_node_zlib_namespaceObject = require("zlib");
;// CONCATENATED MODULE: external "stream"
const external_node_stream_namespaceObject = require("stream");
...
const external_node_util_namespaceObject = require("util");
...
try {
  // Don't use  prefix for this, require+ is not supported until node v14.14
